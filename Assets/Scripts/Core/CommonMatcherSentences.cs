...
namespace Core
{
    public static class CommonMatcherSentences
    {
        ...
        public static MatcherSentence SELF_MAKE_HUMAN_MAKE_OTHER_HUMAN_MAKE = MatcherSentence.Of(SELF, MAKE, HUMAN, MAKE, OTHER_HUMAN, MAKE, TRAILING_ANYTHING);
        public static MatcherSentence SELF_MAKE_HUMAN_MAKE_OTHER_HUMAN_KILL = MatcherSentence.Of(SELF, MAKE, HUMAN, MAKE, OTHER_HUMAN, KILL, NOUN);
